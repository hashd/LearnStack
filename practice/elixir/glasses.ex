defmodule Glasses do
  ...
  defp spill(lvl, pos, [h | []], [curr_lvl | prev_lvls] = spilt) when h > 1 do
    curr_lvl = [ (h-1)/2 | curr_lvl] |> Enum.reverse
    { curr_lvl, [ curr_lvl | prev_lvls] }
  end
  defp spill(lvl, pos, [h | []], [curr_lvl | prev_lvls]) when h >= 0 and h <= 1 do
  ...
  defp spill(lvl, pos, [h1, h2 | t], [curr_lvl | prev_lvls]) when h2 > 1, do: spill(lvl, pos + 1, [h2 | t], [[ (h2-1)/2 | curr_lvl] | prev_lvls])
